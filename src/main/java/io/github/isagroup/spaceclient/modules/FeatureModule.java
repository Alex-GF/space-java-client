...
public class FeatureModule {
    ...
    public FeatureEvaluationResult evaluate(String userId, String featureId, 
                                           ...
                                           boolean details, boolean server) throws IOException {
     ...
     * @throws IOException If the operation fails
     */
    public FeatureEvaluationResult evaluate(String userId, String featureId) throws IOException {
     ...
     * @throws IOException If the operation fails
     */
    public FeatureEvaluationResult evaluate(String userId, String featureId, Map<String, Number> expectedConsumption) throws IOException {
        return evaluate(userId, featureId, expectedConsumption, false, false);
    }

    /**
     * Reverts the optimistic usage level update performed during a previous evaluation
     * This method also invalidates cached data for the user
     *
     * @param userId The ID of the user for whom the feature is being evaluated
     * @param featureId The ID of the feature to be evaluated
     * @param revertToLatest Whether to reset to the latest stored value (true => newest | false => oldest)
     * @return true if the revert operation was successful
     * @throws IOException If the operation fails
     */
    public boolean revertEvaluation(String userId, String featureId, boolean revertToLatest) throws IOException {
     ...
     * @throws IOException If the operation fails
     */
    public boolean revertEvaluation(String userId, String featureId) throws IOException {
     ...
     * @throws IOException If the operation fails
     */
    public String generateUserPricingToken(String userId) throws IOException {
        CacheModule cache = spaceClient.cache;
